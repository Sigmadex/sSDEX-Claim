...
import MetaMaskCardBorder from "./connectorCards/RefMetaMaskCardBorder";
  ...
  return (
    <div className="flex w-screen mt-8 justify-center drop-shadow-2xl scale-75 sm:scale-75 md:scale-100 ">
      <div className="bg-gray-50 h-[30rem] w-[36rem] rounded-2xl grid justify-center items-center">
        <h1 className="font-bold text-4xl text-center mt-8 text-gray-600">Claim sSDEX</h1>
        <div className="flex items-center justify-center ">
          <p className="w-96 text-xs text-center scale-90 sm:scale-100 text-gray-700">
        ...
        <div className="p-3 pr-6 gap-2 flex grow justify-center mb-4">
          <MetaMaskCardBorder
            refWallet={refWallet}
